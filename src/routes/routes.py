...
SECRET_KEY = "tu_palabra_secreta"  # Debe ser la misma que usas en la encriptación de contraseñas
...
@router.post("/users/")
def create_user(user: UserJsonSchema, db: Session = Depends(get_db)):
